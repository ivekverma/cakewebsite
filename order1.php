...
<?php
    $sql="SELECT * FROM `bestsale` WHERE `cake_id`=$id";
    $result=mysqli_query($connect,$sql);
        ...
        <div class="second">
            ...
            <div class="also">
                <div class="fir">
                    ...
                    <h3 class="sectext">'.$row['1kg_price'].'</h3>
                </div>
                <div class="fir">
                    <img src="image/'.$row['flavour'].'/'.$row['flavour'].''.$imagenumber.'.webp"class="im2"  alt="">
                    <h3 class="firtext">2 Kg</h3>
                    <h3 class="sectext">'.$row['2kg_price'].'</h3>
                </div>
            </div>
    ...
    <div class="container">
        <fieldset>
            ...
            <?php
                echo '<form action="/cake/order1.php?cakeid='. $id.' && imagenumber='.$imagenumber.'" method="post">';
            ?>
